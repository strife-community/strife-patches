...
function HarrowerBot:State_Init()
    local abilityQ = LeapAttackAbility.Create(self, self.hero:GetAbility(0))
    local abilityW = SpiritWolfAbility.Create(self, self.hero:GetAbility(1))
    -- E ability is passive
    local abilityR = ShapeshiftAbility.Create(self, self.hero:GetAbility(3))
